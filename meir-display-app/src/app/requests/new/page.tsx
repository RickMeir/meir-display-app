  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        displayReason: formData.displayReason,
        rebatePercentage: formData.rebatePercentage === '' ? null : formData.rebatePercentage,
        cogsDiscountPercentage: formData.cogsDiscountPercentage === '' ? null : formData.cogsDiscountPercentage,
        boardAndLabourCost: formData.boardAndLabourCost === '' ? null : formData.boardAndLabourCost,
        salesForecast12Month: formData.salesForecast12Month,
        repHoursPerMonth: formData.repHoursPerMonth === '' ? null : formData.repHoursPerMonth,
        freeSamplesAndGifts: formData.freeSamplesAndGifts === '' ? null : formData.freeSamplesAndGifts,
        cataloguesPerYear: formData.cataloguesPerYear === '' ? null : formData.cataloguesPerYear,
        displayProductCogs: formData.displayProductCogs === '' ? null : formData.displayProductCogs,
